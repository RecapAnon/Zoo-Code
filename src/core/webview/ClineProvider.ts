	...
	*/
	...
	> {
		...
		return {
			...
			ttsProvider: stateValues.ttsProvider,
			ttsSpeed: stateValues.ttsSpeed ?? 1.0,
			ttsAzureVoice: stateValues.ttsAzureVoice,
			ttsGoogleVoice: stateValues.ttsGoogleVoice,
			ttsOpenAiVoice: stateValues.ttsOpenAiVoice,
			openAiTtsBaseUrl: stateValues.openAiTtsBaseUrl,
			openAiTtsApiKey: stateValues.openAiTtsApiKey,
			azureTtsApiKey: stateValues.azureTtsApiKey,
			googleCloudTtsApiKey: stateValues.googleCloudTtsApiKey,
			azureTtsRegion: stateValues.azureTtsRegion,
